...
SELECT        dbo.ReceiptAllocation.ReceiptAllocationID, dbo.ReceiptAllocation.CommoditySourceID, dbo.ReceiptAllocation.SINumber, dbo.ReceiptAllocation.ProjectNumber, 
                         ...
                         ISNULL(dbo.Receive.BusinessProcessID, 0) AS BusinessProcessID, dbo.ReceiptAllocation.IsClosed, dbo.ReceiptAllocation.IsFalseGRN, dbo.ReceiptAllocation.ETA, dbo.ReceiptAllocation.IsCommited, 
