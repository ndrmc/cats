...
/****** Object:  View [dbo].[VWReceiptAllocation]    Script Date: 11/30/2016 8:56:26 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT        dbo.ReceiptAllocation.ReceiptAllocationID, dbo.ReceiptAllocation.CommoditySourceID, dbo.ReceiptAllocation.SINumber, dbo.ReceiptAllocation.ProjectNumber, 
                         ...
                         dbo.ReceiptAllocation.IsClosed, dbo.ReceiptAllocation.IsFalseGRN, dbo.ReceiptAllocation.ETA, dbo.ReceiptAllocation.IsCommited, 
                         dbo.ReceiptAllocation.GiftCertificateDetailID, dbo.ReceiptAllocation.CommodityID, dbo.ReceiptAllocation.UnitID, dbo.ReceiptAllocation.QuantityInUnit AS AllocatedQuantityInUnit, dbo.ReceiptAllocation.DonorID, 
                         ...
                         dbo.ReceiptAllocation.Remark, dbo.[Transaction].QuantityInUnit AS ReceivedQuantityInUnit
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[12] 4[37] 2[16] 3) )"
      End
